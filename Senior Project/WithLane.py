...
model2 = YOLO("best21_05_2025.pt")  # Change if needed
...
PERSON_CONF_THRESHOLD = 0.3    # Confidence threshold for person detection
...
while cap.isOpened():
    ...
    for det in results1.boxes.data:
        ...
        if cls in TARGET_CLASSES and conf >= PERSON_CONF_THRESHOLD:  # Added confidence check
  ...
  # bottom-center of box
    ...
    if detections:
        results2 = model2(frame, conf=HELMET_CONF_THRESHOLD)[0]  # Added confidence threshold
